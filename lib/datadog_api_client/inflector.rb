    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.get_all_teams_include" => "GetAllTeamsInclude",
          "v2.get_all_teams_sort" => "GetAllTeamsSort",
          ...
          "v2.user_team_serializer_role" => "UserTeamSerializerRole",
        ...
        "v2.team_links_api" => "TeamLinksAPI",
        "v2.team_memberships_api" => "TeamMembershipsAPI",
        "v2.team_permission_settings_api" => "TeamPermissionSettingsAPI",
